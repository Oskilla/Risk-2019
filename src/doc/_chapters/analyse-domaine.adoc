...
Carte <|-- CarteMission
Carte <|-- CarteTerritoire

Armée "1" *-- "1..*" Unité

Plateau "1" *-- "3" DéAttaque : désRouges
Plateau "1" *-- "2" DéDéfense : désBleus
Plateau "1" --> "2..6" Joueur : joueurs
Plateau "1" --> "6" Continent : continents
Plateau "1" --> "58" Carte : cartesJeu

Continent "1" *-- "1..*" Territoire : territoires

Territoire "1" *-- "1..*" Unité : occupants

Joueur "0..1" o-- "0..*" CarteTerritoire : cartes
Joueur "0..1" --> "1" CarteMission : mission
Joueur "1" --> "1" Armée
